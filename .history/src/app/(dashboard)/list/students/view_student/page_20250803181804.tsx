...
export default function StudentsDataPage() {
  ...
  const filteredStudents = useMemo(() => {
    ...
    return filtered
  }, [searchTerm, academicYearFilter, stageFilter, genderFilter, statusFilter, sortColumn, sortDirection, students])
  ...
  // استبدال وظيفة handleEdit
  const handleEdit = (student) => {
    setEditingStudent(student)
    setEditFormData({ ...student })
  }

  // إضافة وظيفة حفظ التعديلات
    ...
    const printContent = `
      ...
      <body>
        <div class="header">
          ...
          <div class="date">إجمالي الطلاب: ${filteredStudents.length}</div>
        </div>
                  ...
                  {currentStudents.map((student, index) => (
                    ...
                    >
                      {visibleColumns.index && (
                        <TableCell className="text-right font-medium">{startIndex + index + 1}</TableCell>
                      )}
                      {visibleColumns.registrationNumber && (
                                        ...
                                        <div className="grid grid-cols-1 md:grid-cols-3 gap-6" dir="rtl">
                                          ...
                                          <div className="space-y-2 text-right">
                                            ...
                                            <div className="p-3 bg-lamaPurpleLight rounded-lg border border-lamaSky/20 text-right">
                                              <Badge
                                                className={
                                                  statusColors[student.registrationStatus] ||
                                    ...
                                    <div className="flex items-center gap-6 text-right">
                                      ...
                                      <div className="flex-1 text-right">
                                        ...
                                        <div className="flex items-center gap-4 text-sm text-gray-600">
                                          ...
                                          <Badge className={statusColors[editFormData.status]}>
                                            {editFormData.status}
                                          </Badge>
                                        </div>
                                      </div>
